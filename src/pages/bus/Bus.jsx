...
<button className="bg-violet-600 h-11 px-4 rounded-md text-base text-neutral-50 font-normal">
    <FaSearch/>
     ...
     >
      ...
      {    }
      <h2 class="text-3xl font-extrabold text-indigo-600 tracking-wide ">
  Range of Buses We Offer
</h2>

      <div className="w-full grid grid-cols-3 gap-10">

<Link to={"/bus/bus-details"} className='w-full bg-neutral-200/60 block dark:bg-neutral-900/40 rounded-xl p-4'>
<img src={Bus1} alt="bus img" className="w-full aspect-video object-cintain object-center" />
...
<Link to={"/bus/bus-details"} className='w-full bg-neutral-200/60 block dark:bg-neutral-900/40 rounded-xl p-4'>
<img src={Bus2} alt="bus img" className="w-full aspect-video object-cintain object-center" />
<div className="px-3 py-4 space-y-2">
    <div className="flex items-center justify-between">
        <h1 className="text-xl font-semibold text-neutral-800 dark:text-neutral-50">
            Private Bus
...
<Link to={"/bus/bus-details"} className='w-full bg-neutral-200/60 block dark:bg-neutral-900/40 rounded-xl p-4'>
<img src={Bus3} alt="bus img" className="w-full aspect-video object-cintain object-center" />
<div className="px-3 py-4 space-y-2">
    <div className="flex items-center justify-between">
        <h1 className="text-xl font-semibold text-neutral-800 dark:text-neutral-50">
            Tourist Bus
...
<Link to={"/bus/bus-details"} className='w-full bg-neutral-200/60 block dark:bg-neutral-900/40 rounded-xl p-4'>
<img src={Bus7} alt="bus img" className="w-full aspect-video object-cintain object-center" />
<div className="px-3 py-4 space-y-2">
    <div className="flex items-center justify-between">
        <h1 className="text-xl font-semibold text-neutral-800 dark:text-neutral-50">
            Luxury Bus
...
<Link to={"/bus/bus-details"} className='w-full bg-neutral-200/60 block dark:bg-neutral-900/40 rounded-xl p-4'>
<img src={Bus8} alt="bus img" className="w-full aspect-video object-cintain object-center" />
<div className="px-3 py-4 space-y-2">
    <div className="flex items-center justify-between">
        <h1 className="text-xl font-semibold text-neutral-800 dark:text-neutral-50">
            Luxury Bus
...
<Link to={"/bus/bus-details"} className='w-full bg-neutral-200/60 block dark:bg-neutral-900/40 rounded-xl p-4'>
<img src={Bus4} alt="bus img" className="w-full aspect-video object-cintain object-center" />
<div className="px-3 py-4 space-y-2">
    <div className="flex items-center justify-between">
        <h1 className="text-xl font-semibold text-neutral-800 dark:text-neutral-50">
           Government Bus
