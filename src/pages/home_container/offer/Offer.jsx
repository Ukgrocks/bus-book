      ...
      <div className="grid grid-cols-2 gap-16">
        <div className="w-full h-auto rounded-xl bg-zinc-200/30 dark:bg-zinc-800/20 p-8 flex items-center gap-x-3 shadow-md">
          ...
          <div className="flex flex-1 flex-col space-y-5">
            ...
            <div className="flex items-cneter gap-x-5">
                <div className="w-fit border border-deashed px-4 py-1 border-neutral-300 dark:border-neutral-800 bg-voilet-500/10 dark:bg-violet-800/5 rounded-md p-3">
                {
                    copied
                    ?
